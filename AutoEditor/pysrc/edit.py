...
def run_autoPremiere(
    ...
    for i in range(len(video_list)):
        ...
        xml_path = current_path + r"\inputvideo\xmlcache" +"\\" + video_list[i].rstrip('.mp4') + '.xml'
        ex_file = ex +  '\\' + video_list[i].rstrip('.mp4') + "edited.mp4"
        print(ex_file)
        ex_file.replace("/", "\\")
        print(ex_file)
...
if __name__=="__main__":
    ...
    run_autoPremiere(current_path,video_list,export_path)